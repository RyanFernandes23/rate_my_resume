...
- 19-22 (STRONG): Strong STAR usage, clear quantifiable impact, and deep technical mastery.
- 23-25 (EXPERT): Exceptional impact (e.g., $1M+ saved, 90%+ optimization, led teams of 10+). Rare technical achievement.

General Guidelines:
- BE CRITICAL. A 25/25 should be extremely rare, reserved for lead engineers or equivalent.
...
- Mention missing TECHNICAL DEPTH.
